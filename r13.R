...
# 두 개의 데이터 프레임을 조인해서 region(지역 이름) 변수를 추가
...
welfare$group_marriage <- ifelse(welfare$marriage == 1, "marriage",
                                 ifelse(welfare$marriage == 2, "divorce", NA))
