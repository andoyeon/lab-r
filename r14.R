...
ggplot(data = exam_by_class, mapping = aes(x = class, y = math)) +
  geom_col()

ggplot(data = exam_by_class) +
  geom_col(mapping = aes(x = class, y = math, fill = "red"), position = "dodge") +
  geom_col(mapping = aes(x = class, y = english, fill = "blue"), position = "dodge")
...
ggplot(data = df, mapping = aes(x = class, y = mean, fill = subject)) +
